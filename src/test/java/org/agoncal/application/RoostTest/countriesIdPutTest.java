...
public class countriesIdPutTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/countries_idPutTest.csv",
				envVarsList);
	}

	@Test
    public void countriesIdPut_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "http://localhost:8080/applicationPetstore/rest";
              ...
              System.out.printf("Test Case %d: countriesIdPut_Test \n", testNumber++);
              System.out.println("Request: PUT /countries/{id}");
