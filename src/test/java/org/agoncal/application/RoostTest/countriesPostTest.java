...
Test generated for /countries_post for http method type POST in rest-assured framework

RoostTestHash=0b304b9f7f
...
public class countriesPostTest {
	...
	public void setUp() {
		...
		String[] envVarsList = { "" };
		envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/countriesPostTest.csv", envVarsList);
	}

	@Test
    public void countriesPost_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "http://localhost:8080/applicationPetstore/rest";
              ...
              System.out.printf("Test Case %d: countriesPost_Test \n", testNumber++);
              System.out.println("Request: POST /countries");
