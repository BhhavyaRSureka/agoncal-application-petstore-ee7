...
Test generated for /items/{id}_delete for http method type DELETE in rest-assured framework

RoostTestHash=fb5fafcc93
...
public class itemsIdDeleteTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/items_idDeleteTest.csv",
				envVarsList);
	}

	@Test
    public void itemsIdDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "http://localhost:8080/applicationPetstore/rest";
              ...
              System.out.printf("Test Case %d: itemsIdDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /items/{id}");
