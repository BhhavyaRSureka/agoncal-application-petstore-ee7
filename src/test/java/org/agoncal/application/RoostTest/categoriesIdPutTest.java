...
public class categoriesIdPutTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/categories_idPutTest.csv",
				envVarsList);
	}

	@Test
    public void categoriesIdPut_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "http://localhost:8080/applicationPetstore/rest";
              ...
              System.out.printf("Test Case %d: categoriesIdPut_Test \n", testNumber++);
              System.out.println("Request: PUT /categories/{id}");
