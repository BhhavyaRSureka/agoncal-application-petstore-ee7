...
public class customersIdDeleteTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/customers_idDeleteTest.csv",
				envVarsList);
	}

	@Test
    public void customersIdDelete_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "http://localhost:8080/applicationPetstore/rest";
              ...
              System.out.printf("Test Case %d: customersIdDelete_Test \n", testNumber++);
              System.out.println("Request: DELETE /customers/{id}");
