...
public class customersIdGetTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/agoncal/application/RoostTest/customers_idGetTest.csv",
				envVarsList);
	}

	@Test
    public void customersIdGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "http://localhost:8080/applicationPetstore/rest";
              ...
              System.out.printf("Test Case %d: customersIdGet_Test \n", testNumber++);
              System.out.println("Request: GET /customers/{id}");
