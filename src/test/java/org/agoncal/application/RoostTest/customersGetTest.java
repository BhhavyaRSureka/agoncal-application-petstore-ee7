...
public class customersGetTest {
	...
	@Test
	public void customersGet_Test() throws JSONException {
		this.setUp();
		...
		for (Map<String, String> testData : envList) {
			...
			System.out.printf("Test Case %d: customersGet_Test \n", testNumber++);
			System.out.println("Request: GET /customers");
				...
				for (int it = 0; it < respoJsonArray.length(); it++) {
					...
					if (response.get("homeAddress") != null) {
						if (response.get("homeAddress.street1") != null) {
							...
							MatcherAssert.assertThat(response.getString("homeAddress.street1").length(),
						...
						if (response.get("homeAddress.city") != null) {
							...
							MatcherAssert.assertThat(response.getString("homeAddress.city").length(),
									lessThanOrEqualTo(50));
						...
						if (response.get("homeAddress.zipcode") != null) {
							...
							MatcherAssert.assertThat(response.getString("homeAddress.zipcode").length(),
						...
						if (response.get("homeAddress.country") != null) {
							if (response.get("homeAddress.country.id") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.id"),
										instanceOf(Integer.class));
							}

							if (response.get("homeAddress.country.version") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.version"),
										instanceOf(Integer.class));
							}

							if (response.get("homeAddress.country.isoCode") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.isoCode"),
										instanceOf(String.class));
								MatcherAssert.assertThat(response.getString("homeAddress.country.isoCode").length(),
										lessThanOrEqualTo(2));
							...
							if (response.get("homeAddress.country.name") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.name"),
										instanceOf(String.class));
								MatcherAssert.assertThat(response.getString("homeAddress.country.name").length(),
							...
							if (response.get("homeAddress.country.printableName") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.printableName"),
										instanceOf(String.class));
								MatcherAssert.assertThat(
										response.getString("homeAddress.country.printableName").length(),
										lessThanOrEqualTo(80));
							...
							if (response.get("homeAddress.country.iso3") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.iso3"),
										instanceOf(String.class));
								MatcherAssert.assertThat(response.getString("homeAddress.country.iso3").length(),
										lessThanOrEqualTo(3));
							...
							if (response.get("homeAddress.country.numcode") != null) {
								MatcherAssert.assertThat(response.get("homeAddress.country.numcode"),
										instanceOf(String.class));
								MatcherAssert.assertThat(response.getString("homeAddress.country.numcode").length(),
										lessThanOrEqualTo(3));
